            ...
            <div className="row">
                <div className="col-lg-8 offset-lg-2 col-md-10 offset-md-1" >
                    <div className="post-preview">
                        <a href="http://rujoota.blogspot.in/2016/10/submit-your-app-to-apple-for-development.html" target="_blank">
                    ...
                    <hr />
                    <div className="post-preview">
                        <a href="http://rujoota.blogspot.in/2016/05/cards-of-wild-game.html" target="_blank">
                            <h2 className="post-title">
                                Cards of wild game
                            </h2>
                            <h4 className="post-subtitle">
                    ...
                    <hr />
                    <div className="post-preview">
                        <a href="http://rujoota.blogspot.in/2015/11/cooking-with-mithu.html" target="_blank">
                            <h2 className="post-title">
                                Cooking with mithu
                            </h2>
                            <h4 className="post-subtitle">
                    ...
                    <div className="post-preview">
                        <a href="http://rujoota.blogspot.in/2013/07/bidding-goodbye-to-dear-friends.html" target="_blank">
                            <h2 className="post-title">
                    ...
                    <hr />
                    <div className="post-preview">
                        <a href="http://rujoota.blogspot.in/2011/07/mile-jab-hum-tum.html" target="_blank">
                            <h2 className="post-title">
                    ...
                    <ul className="pagination justify-content-end">
                        <li className="page-item">
                            <a href="http://rujoota.blogspot.in/" target="_blank" className="page-link view-more-btn">View more &rarr;</a>
                        </li>
                    </ul>
                </div>
        </div>
